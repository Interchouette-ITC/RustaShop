...
Prefer a private [GitHub Security Advisory](https://github.com/Interchouette-ITC/rustashop/security/advisories/new)
...
[`../docs-dev/SUPPLY-CHAIN.md`](../docs-dev/SUPPLY-CHAIN.md). That document is
